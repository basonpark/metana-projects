...
export default function Home() {
  ...
  return (
    ...
    >
      <RetroGrid />
      <div className="absolute inset-0 w-full h-full bg-[radial-gradient(circle_500px_at_50%_200px,rgba(100,100,255,0.1),transparent)]" />

      <div className="relative z-10 flex flex-col items-center gap-16 max-w-7xl mx-auto">
        <h1 className="text-7xl font-bold text-slate-300 text-center pt-20 mt-20">
          <FlipText className="text-xl mb-3" word="Welcome to" />
