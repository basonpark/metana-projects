...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center gap-5 mx-auto p-4 h-screen">
      <h1 className="text-2xl font-bold">Welcome to ERC1155 Token Minting and Forging</h1>
      <TokenBalances />
      <MintToken />
      <ForgeToken />
      <TradeToken />
      <a href="https://opensea.io/" target="_blank" rel="noopener noreferrer">View onOpenSea</a>
