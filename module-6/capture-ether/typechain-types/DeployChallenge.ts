...
export interface DeployChallengeInterface extends utils.Interface {
  functions: {
...
export interface DeployChallenge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployChallengeInterface;
