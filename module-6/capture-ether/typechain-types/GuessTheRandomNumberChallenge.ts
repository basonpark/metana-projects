...
export interface GuessTheRandomNumberChallengeInterface
...
export interface GuessTheRandomNumberChallenge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuessTheRandomNumberChallengeInterface;
