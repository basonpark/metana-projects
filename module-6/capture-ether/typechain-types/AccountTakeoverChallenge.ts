...
export interface AccountTakeoverChallengeInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "authenticate" | "isComplete"
  ): FunctionFragment;
...
export interface AccountTakeoverChallenge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountTakeoverChallengeInterface;
